...
class Modal05CreateProjectWidget extends StatefulWidget {
  const Modal05CreateProjectWidget({
    super.key,
    required this.datosdeactualizacion,
  });

  final DocumentReference? datosdeactualizacion;
  ...
  Widget build(BuildContext context) {
    return BackdropFilter(
      ...
      child: StreamBuilder<ProductoRecord>(
        stream: ProductoRecord.getDocument(widget!.datosdeactualizacion!),
                                    ...
                                    child: TextFormField(
                                      controller:
                                          _model.descriptionTextController ??=
                                              TextEditingController(
                                        text:
                                            containerProductoRecord.description,
                                      ),
                                    ...
                                    child: TextFormField(
                                      controller:
                                          _model.projectURLTextController ??=
                                              TextEditingController(
                                        text: containerProductoRecord.price
                                            .toString(),
                                      ),
                                    ...
                                    child: TextFormField(
                                      controller:
                                          _model.clonableURLTextController ??=
                                              TextEditingController(
                                        text: containerProductoRecord.quantity
                                            .toString(),
                                      ),
