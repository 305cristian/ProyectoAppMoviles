...
import 'actualizar_datos_model.dart';
export 'actualizar_datos_model.dart';

class ActualizarDatosWidget extends StatefulWidget {
  const ActualizarDatosWidget({super.key});

  @override
  State<ActualizarDatosWidget> createState() => _ActualizarDatosWidgetState();
}

class _ActualizarDatosWidgetState extends State<ActualizarDatosWidget> {
  late ActualizarDatosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ActualizarDatosModel());
  }
