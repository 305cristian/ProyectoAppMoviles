...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'eliminar',
          path: '/eliminar',
          builder: (context, params) => EliminarWidget(),
        ),
        FFRoute(
          name: 'ActualizarDatos',
          path: '/actualizarDatos',
          builder: (context, params) => ActualizarDatosWidget(),
        ),
        FFRoute(
          name: 'ConsultadeProducto',
          path: '/consultadeProducto',
          builder: (context, params) => ConsultadeProductoWidget(),
        ),
        FFRoute(
          name: 'Usuario',
          path: '/usuario',
